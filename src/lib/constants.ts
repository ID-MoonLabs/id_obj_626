...
> = {
  "金融机构（以商业银行为例）": [
    {
      dimension: "投融资组合排放",
      category: "类别15：投资",
      description: "几乎所有范围三排放来源于支持的融资与投资活动，需按持股比例分摊被投企业排放。",
    ...
    },
    {
      ...
      description: "涵盖IT设备采购、咨询与市场等服务支出，通过财务支出估算间接排放。",
  ...
  "交通运输业（以航空公司为例）": [
    {
      ...
      description: "覆盖航空燃油的开采、炼制、运输等上游排放，是航空业范围三核心。",
    ...
    },
    {
      ...
      description: "飞机、发动机等高价值资本品的制造排放需按使用年限进行摊销。",
      formula: "Σ(采购飞机数量 × 单架飞机建造排放 × 摊销系数) + 相关服务排放",
      note: "可采用供应商LCA或行业平均数据。",
    },
    {
      dimension: "外包与地面服务",
      category: "类别6：商务旅行；类别9：下游运输和配送",
      description: "地勤、维修、餐饮等外包服务以及员工商务出行带来的排放。",
  ...
  "数字科技行业（以云服务/互联网公司为例）": [
    ...
    },
    {
      ...
      formula: "Σ(自建数据中心所耗建材用量 × 建材排放因子) + Σ(租赁面积 × 间接排放因子)",
  ...
  "新材料行业（以先进化工材料/复合材料为例）": [
    ...
    },
    {
      ...
      description: "售出产品在使用阶段的能耗或排放，按销售数量与典型使用工况估算。",
  ...
  "电子信息业（以智能手机制造为例）": [
    ...
    },
    {
      ...
      formula: "Σ(售出设备数量 × 单台设备年耗电量 × 使用年限 × 电网排放因子)",
      note: "不同地区电网因子差异显著。",
    },
    {
      dimension: "物流与分销",
  ...
  "医疗行业（以大型综合医院为例）": [
    {
      dimension: "药品与耗材供应链",
      category: "类别1：采购的商品和服务",
      description: "药品、耗材的大量采购是范围三主要来源，多采用财务法估算。",
  ...
  "电力行业（以火电厂为例）": [
    ...
    },
    {
      dimension: "售出电力的使用",
      category: "类别11：售出产品的使用",
      description: "下游用户消费所售电力产生的排放，一般需根据监管要求披露。",
    ...
    },
    {
      ...
      formula: "Σ(建设材料用量 × 材料排放因子) + Σ(退役处置量 × 处置排放因子)",
      note: "大型基建项目需覆盖全生命周期。",
    },
  ],
}
...
export const API_BASE_URL =
  process.env.NEXT_PUBLIC_CARBON_API_BASE_URL || "http://localhost:18080/b/ibot"
